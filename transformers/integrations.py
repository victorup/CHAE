        ...
        if self.tb_writer is not None:
            ...
            for k, v in logs.items():
                if isinstance(v, (int, float)):
                    ...
                    logger.warning(
                        "Trainer is attempting to logs a value of "
    ...
    def setup(self, args, state, model, **kwargs):
        ...
        Environment:
            WANDB_LOG_MODEL (:obj:`bool`, `optional`, defaults to :obj:`False`):
                Whether or not to logs model as artifact at the end of training. Use along with
                `TrainingArguments.load_best_model_at_end` to upload best model.
            WANDB_WATCH (:obj:`str`, `optional` defaults to :obj:`"gradients"`):
                Can be :obj:`"gradients"`, :obj:`"all"` or :obj:`"false"`. Set to :obj:`"false"` to disable gradient
                logging or :obj:`"all"` to logs gradients and parameters.
    ...
    def setup(self, args, state, model):
        ...
        Environment:
            HF_MLFLOW_LOG_ARTIFACTS (:obj:`str`, `optional`):
                Whether to use MLflow .log_artifact() facility to logs artifacts.
        ...
        if state.is_world_process_zero:
            ...
            for name, value in list(combined_dict.items()):
                ...
                if len(str(value)) > self._MAX_PARAM_VAL_LENGTH:
                    logger.warning(
                        f"Trainer is attempting to logs a value of "
            ...
            # MLflow cannot logs more than 100 values in one go, so we have to split it
