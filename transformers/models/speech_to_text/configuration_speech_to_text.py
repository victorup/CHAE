...
class Speech2TextConfig(PretrainedConfig):
    ...
    Args:
        ...
        max_source_positions (:obj:`int`, `optional`, defaults to 6000):
            The maximum sequence length of logs-mel filter-bank features that this model might ever be used with.
        ...
        input_feat_per_channel (:obj:`int`, `optional`, defaults to 80):
            An integer specifying the size of feature vector. This is also the dimensions of logs-mel filter-bank
            features.
