...
class BenchmarkArguments:
    ...
    log_print: bool = field(default=False, metadata={"help": "Save all print statements in a logs file"})
    ...
    log_filename: str = field(
        ...
        metadata={"help": "Log filename used if print statements are saved in logs."},
    )
